/****************************************************************************  
  ...
  $Id: ftpd.c,v 1.31 2012/01/07 23:23:57 wmaton Exp $
...
#define FTPD_OPTS	":4aAcdhHiIlLoP:qQr:t:T:u:UvVwWxX"
#if defined(DAEMON)
...
#    if defined(AIX) || defined(SOLARIS_2) || defined(__sgi)
	strlcpy(ls_long, "/bin/ls -lA", sizeof(ls_long));
#    else /* !(defined(AIX) || defined(SOLARIS_2) || defined(__sgi)) */ 
	strlcpy(ls_long, "/bin/ls -la", sizeof(ls_long));
#    endif /* !(defined(AIX) || defined(SOLARIS_2) || defined(__sgi)) */ 
#  else /* !(defined(SVR4) || defined(ISC)) */ 
	strlcpy(ls_long, "/bin/ls -lgA", sizeof(ls_long));
#  endif /* !(defined(SVR4) || defined(ISC)) */ 
    }
