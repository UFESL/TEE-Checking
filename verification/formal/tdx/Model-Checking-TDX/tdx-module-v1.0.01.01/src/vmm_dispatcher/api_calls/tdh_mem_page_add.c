                           ...
                           uint64_t source_page_pa)
{
    ...
    tdr_t* tdr_ptr = malloc(sizeof(tdr_t));
    ...
    tdr_ptr->key_management_fields.hkid = x;
    ...
    tdcs_t* tdcs_ptr = malloc(sizeof(tdcs_t));
    ...
    bool_t x3;
    tdcs_ptr->management_fields.finalized = x3;
    ...
    pamt_entry_t* td_page_pamt_entry_ptr = malloc(sizeof(pamt_entry_t));
