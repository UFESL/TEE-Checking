...
#include "/home/hasini/Desktop/TEE/Verification/TEE/verification/formal/tdx/tdx-module-v1.0.01.01/src/common/x86_defs/x86_defs.h"
#include "/home/hasini/Desktop/TEE/Verification/TEE/verification/formal/tdx/Model-Checking-TDX/tdx-module-v1.0.01.01/src/common/data_structures/td_control_structures.h"
...
api_error_type tdh_mng_create(uint64_t target_tdr_pa, hkid_api_input_t hkid_info)
{
    ...
    assert((is_private_hkid(td_hkid)) && return_val == TDX_SUCCESS);
    ...
    // assert(global_data->kot.entries[td_hkid].state == KOT_STATE_HKID_FREE);
    // assert(tdr_ptr->management_fields.lifecycle_state != TD_HKID_ASSIGNED);
