...
/**
 * @file tdh_mem_page_remove_harness.c
 * @brief Implements the proof harness for tdh_mem_page_remove function.
 */
...
void harness(void)
{
  ...
  tdh_mem_page_remove(target_page_info, target_tdr_pa);
}
